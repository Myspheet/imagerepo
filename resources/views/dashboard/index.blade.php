    ...
    <div class="col-md-12">
        <div class="panel panel-default card-view">
            {{-- <div class="panel-heading">
                <div class="pull-left">
                    <h6 class="panel-title txt-dark">{{$project->title}}</h6>
                </div>
                        ...
                        <div class="portfolio-wrap project-gallery">
                            <ul id="portfolio_1" class="portf auto-construct  project-gallery" data-col="4">
                                {{-- @foreach ($project->images as $index => $image)
                                    <li class="item" data-src="{{asset('storage/'. $project->id . '/' . $image->image)}}"
                                        data-sub-html="<a href='{{ route('admin.image.delete', [$project->slug, $image->id]) }}' id='delete{{$image->id}}'
                                            style='color:red; font-size:2em'>Delete Picture</a>">

                                        <a href="#">
                                            <img class="img-responsive" src="{{asset('storage/'. $project->id . '/' . $image->image)}}" alt="Image description" />
