		...
		<div class="wrapper  pa-0">
			<header class="sp-header">
				...
				<div class="form-group mb-0 pull-right">
					...
					<a class="inline-block btn btn-orange btn-rounded" href="{{route('login')}}">Sign In</a>
				</div>
							...
							<div class="auth-form  ml-auto mr-auto no-float card-view pt-30 pb-30">
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Sign up to {{ config('app.name', 'Laravel') }}</h3>
										...
										<div class="form-wrap">
                                            <form method="POST" action="{{ route('register') }}">
												...
												<div class="form-group text-center">
													<button type="submit" class="btn btn-orange btn-rounded">sign Up</button>
												</div>
											</form>
										</div>
									</div>
